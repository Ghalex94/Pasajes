...
public class viSeleccionAsientos2 extends JInternalFrame implements ActionListener, PropertyChangeListener, KeyListener {
	...
	public viSeleccionAsientos2(vPrincipal temp) {
		...
		lblCuentaTotal.setBounds(1053, 151, 208, 32);
		...
		btnfinalizarEImprimir.setBounds(1053, 223, 282, 62);
		...
		cbDestino.setBounds(582, 245, 441, 40);
		...
		lblTotal.setBounds(1103, 183, 208, 32);
		...
		cbHoraDestino.setBounds(919, 203, 52, 32);
		...
		cbMinutoDestino.setBounds(972, 203, 52, 32);
		...
		dchDestino.setBounds(788, 203, 126, 32);
		...
		chbxVerTotal.setBounds(1310, 157, 25, 26);
