...
public class viSeleccionAsientos2 extends JInternalFrame implements ActionListener {
	...
	protected void actionPerformedBtnA1(ActionEvent arg0) {
		...
		if(btnA1.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 1, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA2(ActionEvent arg0) {
		...
		if(btnA2.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 2, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA3(ActionEvent arg0) {
		...
		if(btnA3.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 3, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA4(ActionEvent arg0) {
		...
		if(btnA4.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 4, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA5(ActionEvent arg0) {
		...
		if(btnA5.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 5, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA6(ActionEvent arg0) {
		...
		if(btnA6.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 6, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA7(ActionEvent arg0) {
		...
		if(btnA7.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 7, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA8(ActionEvent arg0) {
		...
		if(btnA8.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 8, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA9(ActionEvent arg0) {
		...
		if(btnA9.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 9, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA10(ActionEvent arg0) {
		...
		if(btnA10.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 10, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA11(ActionEvent arg0) {
		...
		if(btnA11.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 11, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA12(ActionEvent arg0) {
		...
		if(btnA12.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 12, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA13(ActionEvent arg0) {
		...
		if(btnA13.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 13, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA14(ActionEvent arg0) {
		...
		if(btnA14.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 14, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
	protected void actionPerformedBtnA15(ActionEvent arg0) {
		...
		if(btnA15.getBackground() == Color.RED)
			estado = 1;
		vdAsiento vdp = new vdAsiento(vp, 15, estado, null, this, null, null);
		vdp.setVisible(true);
		vp.enable(false);
	}
